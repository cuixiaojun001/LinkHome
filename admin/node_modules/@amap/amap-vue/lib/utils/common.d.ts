...
export declare function pass<T>(anything: T): T;
...
export declare function mergeArray(to: any[], ...froms: any[][]): any[];
export declare function isPlainObject(obj: any): obj is Record<string, any>;
export declare function timeBegin(tag: string): void;
export declare function timeEnd(tag: string): void;
